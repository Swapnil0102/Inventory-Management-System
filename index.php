...
<ul class="list-unstyled components mb-5">
  ...
  <li>
      <a href="admin.php"><span class="fa fa-user mr-3"></span> Admin</a>
  </li>
  <li>
    <a href="store_keeper.php"><span class="fa fa-shopping-cart mr-3"></span> Store Keeper</a>
  </li>
  <li>
    <a href="fic_iws.php"><span class="fa fa-paper-plane mr-3"></span> FIC IWS</a>
  </li>
  <li>
    <a href="fic_electrical.php"><span class="fa fa-paper-plane mr-3"></span> FIC Electrical</a>
  </li>
  <li>
    <a href="requisition.php"><span class="fa fa-paper-plane mr-3"></span> Faculty And Others</a>
  </li>
</ul>
...
<!-- <h2 class="pb-2 border-bottom">Columns with icons</h2> -->
                ...
                <div class="feature col">
                    ...
                    <a href="admin.php" class="icon-link">
                    <h2>Admin</h2>
                    </a>
                ...
                <div class="feature col">
                    ...
                    <a href="store_keeper.php" class="icon-link">
                    <h2>Store keeper</h2>
                </a>
                    <svg class="bi" width="1em" height="1em"><use xlink:href="#chevron-right"/></svg>
                </div>
                ...
                <div class="feature col">
                    ...
                    <a href="fic_iws.php" class="icon-link">
                    <h2>FIC IWS</h2>
                </a>
                    <svg class="bi" width="1em" height="1em"><use xlink:href="#chevron-right"/></svg>
                </div>
                ...
                <div class="feature col">
                    ...
                    <a href="fic_electrical.php" class="icon-link">
                    <h2>FIC Electrical</h2>
                </a>
                    <svg class="bi" width="1em" height="1em"><use xlink:href="#chevron-right"/></svg>
                    ...
                    <a href="requisition.php" class="icon-link">
                    <h2>Faculty and Others</h2> <br>
                    </a>    
                    <svg class="bi" width="1em" height="1em"><use xlink:href="#chevron-right"/></svg>
                </div>
                </div>
