...
<?php
      if (isset( $_POST['itemno'])){ 
        $_SESSION['index']= $_POST['itemno'];
            header('Location: requisition_elec_submit.php');
            exit();
}}
?>
...
<body>
    ...
    <img src="/ims-nitttr-kolkata/logo/logo.jpg" height="55px" width="55px" alt="">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            ...
            <form class="d-flex" form action= "fic_elec_requisition.php" method="POST">
...
if($_SESSION['insertreq']== "elec_inserted"){
...
?>
  ...
  <form action="/ims-nitttr-kolkata/fic_elec_requisition.php" method="post">
    <center>
    <h1>FIC Electrical Requisition</h1>
    </center>
    <hr><br>
    <h2>Add New Request</h2><br>
    <!-- <form class="row g-3" action="/ims-nitttr-kolkata/fic_elec_requisition.php" method="POST"> -->
    ...
    <div class="col-md-12">
      ...
      <!-- <input type="submit" name="itemno" id="itemno" action="/ims-nitttr-kolkata/fic_elec_requisition.php" formvalue="Submit" /> -->
    ...
    // } 
      ...
      <input type="submit" class="btn btn-primary btn-lg"  action="/ims-nitttr-kolkata/fic_elec_requisition.php" formvalue="Submit" value="Enter"/>
