...
$bin = 0;
  ...
  if($mysqli->connect_errno){
    ...
    if(isset($_GET['delete'])){
      ...
      $sql1= "SELECT `detailed_description`, `quantity` FROM `stock_issue_recurring_electrical` WHERE `sno` = $sno";
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST'){
      ...
      $sql1= "SELECT `detailed_description` FROM `stock_issue_recurring_electrical` WHERE `sno` = $sno";
      $result1 = mysqli_query($mysqli, $sql1);
      $row = mysqli_fetch_assoc($result1);
      $item_name= $row["detailed_description"];   
        ...
        $sql = "UPDATE `stock_issue_recurring_electrical` SET `requisition_no` = '$requisition_no', `challan_No` = '$challan_No', `item_date` = '$item_date',`detailed_description` = '$detailed_description',
        ...
        `balance` = '$balance', `remarks` = '$remarks', `bin` = '$bin'  WHERE `stock_issue_recurring_electrical`.`sno` = $sno";
        ...
        // Sql query to be executed
        $sql = "INSERT INTO `stock_issue_recurring_electrical`(`requisition_no`, `challan_No`, `item_date`,`detailed_description`, `name_of_supplier`, `order_no`,`order_date`, `quantity`, `unit_price`, `total_price`, `reference_to_issue_voucher`, `quantity_issued`, `balance`, `remarks`, `bin`) 
  ...
  <div class="modal fade" id="editModal" tabindx="-1" aria-labelled_by="editModalLabel" aria-labelledby="editModalLabel"
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form action="/ims-nitttr-kolkata/edit_SR_Electrical.php" method="POST">
...
//   $_SESSION['index10'] = 1;
 ...
 <div class="inr_top_bar">
        ...
        <h4> 
            <ull>
            	<a href="store_keeper.php">  Store Keeper  </a> >
                 <lii><a href="edit_SR_Electrical.php"> Electrical Recurring </a></lii>
            </ull>
        </h4>
    	</div>
    </div>
    <br>
      ...
      <br><center><h1> Electrical Recurring (Stock/Issue) </h1></center><hr>
  <div class="container my-4 "><br>

    <h2>Item Stock and Issue</h2>
    <form action="/ims-nitttr-kolkata/edit_SR_Electrical.php?update=true" method="POST">
      <div class="form-group">
    ...
    <div class="container my-4">
      ...
      <table class="table" assign="center" id="myTable">
        ...
        <tbody>
          <?php
            $sql = "SELECT * FROM stock_issue_recurring_electrical";
            $result = mysqli_query($mysqli, $sql);
            $sno = 0;
