   ...
   <nav class="navbar navbar-expand-lg navbar-dark bg-dark pt-3 pb-3">
    <img src="/ims-nitttr-kolkata/logo/logo.jpg" height="55px" width="55px" alt="">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            ...
            <form class="d-flex" form action= "fic_iws.php" method="POST">
...
<div class="wrapper d-flex align-items-stretch">
  <nav id="sidebar">
    ...
    <div class="wrapper d-xl-inline-flex">
        <div class="mbb-5">
            <h3 class="h6 mb-3"> 
                <button class="btnn" type="submit">Welcome! <br> FIC  </button>
            </h3>
    </div>
  </div>
</nav>
...
<div class="inr_top_bar">
	<div class="container">
        <br>
        <a href="fic_iws.php"><h3> FIC IWS ></h3></a>
            <!-- <h3>Home</h3> -->
      ...
      <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
        ...
        <div class="feature col">
          <div class="container p-3 my-3 border">
            ...
            <a href="fic_iws_requisition.php" class="icon-link">
              <h2>IWS Requisition</h2>
            </a>
            <svg class="bi" width="1em" height="1em">
        ...
        <div class="feature col">
          <div class="container p-3 my-3 border ">
            ...
            <a href="fic_iws_approval.php" class="icon-link">
              <h2>Acknowledge</h2>
            </a>
            <svg class="bi" width="1em" height="1em">
              <use xlink:href="#chevron-right" />
