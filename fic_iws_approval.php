   ...
   <nav class="navbar navbar-expand-lg navbar-dark bg-dark pt-3 pb-3">
    <img src="/ims-nitttr-kolkata/logo/logo.jpg" height="55px" width="55px" alt="">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            ...
            <form class="d-flex" form action= "fic_iws_approval.php" method="POST">
    ...
    <div class="wrapper d-flex align-items-stretch">
      ...
      <div class="wrapper d-xl-inline-flex">
          <div class="mbb-5">
              <h3 class="h6 mb-3"> 
                  <button class="btnn" type="submit">Welcome! <br> FIC <br> Recurring </button>
              </h3>
          </div>
          </div>
...
<br>
 <div class="inr_top_bar">
	<div class="container">
        <h4> 
            <ull>
            	<a href="fic_iws.php">  FIC IWS </a> >
                 <lii><a href="fic_iws_approval.php"> FIC IWS Acknowledge </a></lii>
            </ull>
        </h4>
    	</div>
    </div>
...
<form action="/ims-nitttr-kolkata/fic_iws_approval.php" method="POST">
    ...
    <div class="container my-4">
        <div class="container">
          ...
          <table class="table" id="myTable">
            ...
            $sql = "SELECT * FROM `requisition_pdf` WHERE `approval` =  'Not Approved'  && `indenter` =  'FIC IWS'   ORDER BY `sno` DESC LIMIT 100 ";
            $result = mysqli_query($mysqli, $sql);
            $sno = 0;
